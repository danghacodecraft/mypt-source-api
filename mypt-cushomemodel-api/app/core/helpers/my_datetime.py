...
from app.core.helpers.global_variable import FORMAT_DATETIME
...
def getFormatDatetimeNow(format_datetime=FORMAT_DATETIME['datetime']):
    return datetime.now().strftime(format_datetime)


def get_second_now_to_end_day():
    ...
    return (end_of_day - current_time).seconds
