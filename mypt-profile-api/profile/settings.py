...
REDIS_HOST = config('CENTRALIZED_SESSION_REDIS_HOST')
REDIS_PORT = config('CENTRALIZED_SESSION_REDIS_PORT')
REDIS_DB = config('CENTRALIZED_SESSION_REDIS_DATABASE')
...
SERVICE_REDIS_DATABASE = int(config("PROFILE_REDIS_DATABASE"))
